...
generate(InputFiles, OutputFile, Apps, Verbose) ->
    ...
    case rebar_coverage:init(InputFiles, "_build/test/covertool.log") of
        {ok, F} ->
...
generate_app(App, Result) ->
    ...
    Coverage = rebar_coverage:analyze(maps:keys(Modules)),
